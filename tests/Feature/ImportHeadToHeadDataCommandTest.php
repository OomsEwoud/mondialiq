...
class ImportHeadToHeadDataCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    private Team $otherHomeTeam;

    private Team $otherAwayTeam;
    ...
    public function test_it_imports_a_single_fixture_pair(): void
    {
        $pairKey = "{$this->homeTeam->id}-{$this->awayTeam->id}";

        $this->mock(HeadToHeadService::class, function (MockInterface $mock) use ($pairKey): void {
    ...
    public function test_it_skips_fresh_data_and_avoids_duplicate_pair_imports(): void
    {
        Fixture::create([
            'external_id' => 3002,
        ...
        $this->mock(HeadToHeadService::class, function (MockInterface $mock) use (
            $firstPairKey,
            $secondPairKey,
        ): void {
            $mock->shouldReceive('makePairKey')
    ...
    public function test_it_force_imports_all_fixture_pairs(): void
    {
        Fixture::create([
            'external_id' => 3004,
            'league_id' => $this->fixture->league_id,
