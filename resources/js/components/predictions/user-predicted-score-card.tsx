    ...
    return (
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_1.2fr_1fr] lg:items-center">
            <Link
                ...
                className="group flex flex-col items-center gap-3 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition-colors hover:bg-cyan-50/30"
            >
                <img
            ...
            <div className="rounded-2xl border border-slate-200 bg-gradient-to-b from-white to-slate-50/60 px-6 py-6 text-center shadow-md sm:px-10 sm:py-8">
